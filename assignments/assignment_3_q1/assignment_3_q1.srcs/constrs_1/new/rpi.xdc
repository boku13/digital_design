...
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { Y[5] }]; #rpio_12
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { Y[4] }]; #rpio_13
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { Y[3] }]; #rpio_22
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { Y[2] }]; #rpio_23
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { Y[1] }]; #rpio_24
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { Y[0] }]; #rpio_25
