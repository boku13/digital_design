...
HD_PWD='C:/Users/SQREAM/Desktop/sem4/DigitalDesign/decimal_on_seven_segment/decimal_on_seven_segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_on_seven_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_on_seven_seg.tcl -notrace
