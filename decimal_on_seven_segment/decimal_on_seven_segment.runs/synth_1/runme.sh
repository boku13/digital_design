...
HD_PWD='C:/Users/SQREAM/Desktop/sem4/DigitalDesign/decimal_on_seven_segment/decimal_on_seven_segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_on_seven_seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_on_seven_seg.tcl
