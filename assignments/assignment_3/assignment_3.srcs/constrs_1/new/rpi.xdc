...
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { I0 }]; #rpio_18
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { I1 }]; #rpio_19
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { I2 }]; #rpio_20
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { I3  }]; #rpio_26